...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await logActivity({ entityType: 'ticket', entityId: params.id, action: internal ? 'internal_note' : 'replied', user })
  ...
  if (!internal) {
    ...
    if (isClient) {
      ...
      await notify([ticket.customer?.user_id, ticket.created_by], 'ticket_reply', title,
